            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{asset('template')}}/dist/img/ita.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">Diana Ayu Puspita</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{asset('template')}}/dist/img/ita.png" class="img-circle" alt="User Image">
                    <p>
                      Diana Ayu Puspita - Web Developer
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="{{asset('template')}}/dist/ita.png" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
              <p>Diana Ayu Puspita</p>
